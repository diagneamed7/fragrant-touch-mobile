    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Liens rapides */}
          <div className="space-y-4">
            <h3 className="font-playfair text-xl font-semibold text-gold-400">Liens Rapides</h3>
            <div className="space-y-2">
              <a href="/" className="block text-gray-300 hover:text-gold-400 transition-colors">
                Accueil
              </a>
              <a href="/parfums" className="block text-gray-300 hover:text-gold-400 transition-colors">
                Nos Parfums
              </a>
              <a href="/contact" className="block text-gray-300 hover:text-gold-400 transition-colors">
                Contact
              </a>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="font-playfair text-xl font-semibold text-gold-400">Nous Contacter</h3>
